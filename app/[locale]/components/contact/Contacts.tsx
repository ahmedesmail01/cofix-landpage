        ...
        <div className="grid grid-cols-1 w-full gap-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mb-4">
              <span className="text-gray-600">Phone: +971 2732</span>
            </div>
            ...
            <div className="mb-4">
              <p className="text-gray-600">
                Email:{" "}
                <a
                  href="mailto:info@corporatefix.net"
                  className="text-[#0d519d] hover:underline"
                >
                  info@corporatefix.net
                </a>
              </p>
            </div>
            ...
            <div className="mb-8">
              <p className="text-gray-600">
                Location: 62 Khalifa City, Abu Dhabi, UAE
              </p>
            </div>
          </div>
          ...
          {/* Based In */}
          <div>
            <h2 className="text-2xl font-bold mb-6">Based in</h2>
            <div className="mb-8">
